...
class ConservativeObjectiveModel(tf.Module):
    ...
    def optimize(self, x, steps, **kwargs):
        ...
        return tf.while_loop(
            lambda xt: True, gradient_step, (x,), # cond= lambda xt: True, #body= gradient_step, #loop_vars=(x,),  
            maximum_iterations=steps)[0]          # equivalent to: x = gradient_step(x) for 50 steps
